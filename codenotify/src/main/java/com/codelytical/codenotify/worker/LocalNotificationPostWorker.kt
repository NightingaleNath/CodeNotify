...
class LocalNotificationPostWorker(
    ...
    companion object {
        ...
        const val TARGET_COMPONENT_TYPE_KEY = "fragment"
    ...
    private suspend fun enqueueNotification() {
        ...
        val targetComponentType = inputData.getString(TARGET_COMPONENT_TYPE_KEY)
        val customObject = inputData.getString(OBJECT_KEY)
        ...
        val data = Data.Builder().apply {
            ...
            putString(TARGET_COMPONENT_TYPE_KEY, targetComponentType)
            putString(OBJECT_KEY, customObject)
        ...
        val localNotifyShowWorkRequest = OneTimeWorkRequestBuilder<LocalNotificationShowWorker>()
            .setInitialDelay(timeInternal, TimeUnit.SECONDS)
            .setInputData(data.build())
            .build()
        saveWorkerId(id = localNotifyShowWorkRequest.id)
        WorkManager.getInstance(context).enqueue(localNotifyShowWorkRequest)
    }
